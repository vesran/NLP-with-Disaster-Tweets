...
embeddings_index = {}
with open(os.path.join('./data', 'glove.twitter.27B.100d.txt'), encoding='utf-8') as f:
    lines = f.readlines()
...
model.add(a := tf.keras.layers.Embedding(input_dim=len(word_index)+1, output_dim=100, input_length=max_length,
